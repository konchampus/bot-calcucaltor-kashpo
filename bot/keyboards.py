...
def review_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="Изменить длину стойки", callback_data="review:edit:rack_length")],
            [InlineKeyboardButton(text="Изменить ширину ротанга", callback_data="review:edit:rattan_width")],
            [InlineKeyboardButton(text="Изменить диаметр корзины", callback_data="review:edit:basket_diameter")],
            [InlineKeyboardButton(text="Изменить количество жгутов", callback_data="review:edit:harness_count")],
...
def pattern_selector_keyboard(
    ...
    buttons.append([InlineKeyboardButton(text="Назад", callback_data="calc_patterns:back")])
